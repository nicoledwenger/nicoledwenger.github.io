...
const About = () => (
    <div id="about" style={{marginTop: '10%'}}>
        ...
        <ProjectContainer>
          <Container>
            <Paragraph>I'm Nicole Dwenger, a front end developer and designer. I graduated <i>cum laude</i> at Purdue University with degrees in Web Programming and Public Relations. I've gained a wealth of knowledge and expertise by working in various fields and companies including General Motors, CDW, and Purdue University.</Paragraph>
